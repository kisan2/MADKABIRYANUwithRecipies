...
export default class PrintAgain extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ padding: "5px 0" }}>{Logo.printname}</p>
                ...
                <div style={{
                    ...
                    <table style={{
                        ...
                        <tr>
                            ...
                            <td style={{ fontWeight: "900", width: "70%", fontsize: '28px' }}>
                                {this.props.data[0].refNo}</td>
                        </tr>
                        <tr>
                            <td style={{ width: "20%", }}>Kot No</td>
                            <td style={{ width: "2%" }}>:</td>
                            <td style={{ fontWeight: "600", width: "70%" }}>
                                {this.props.data[0].kotId}</td>
                        </tr>
                        <tr>
                            <td>Bill No.</td>
                            <td>:</td>
                            <td>{this.props.data[0].invoiceNo}</td>
                        </tr>
                        <tr>
                            <td style={{ width: "35%" }}>Customer Name</td>
                            <td>:</td>
                            <td style={{ textTransform: 'capitalize' }}>{this.props.data[0].customer.name}</td>
                        </tr>
                        <tr>
                            <td>Phone No.</td>
                            <td>:</td>
                            <td>{this.props.data[0].customer.phoneNo}</td>
                        </tr>
                        <tr>
                            <td style={{ verticalAlign: "top" }}>Address</td>
                            <td style={{ verticalAlign: "top" }}>:</td>
                            <td style={{ textTransform: 'capitalize' }}>{this.props.data[0].customer.address}</td>
                        </tr>
                        <tr>
                            <td>HD By</td>
                            <td>:</td>
                            <td style={{ textTransform: 'capitalize' }}>{this.props.data[0].deliveryPerson}</td>
                        </tr>
                        <tr>
                            <td>Total Items</td>
                            <td>:</td>
                            <td>{this.props.data[0].item.length}</td>
                        </tr>
                        <tr>
                            <td>Total Quantity</td>
                            <td>:</td>
                            <td>{this.props.data[0].totalQuantity}</td>
                        </tr>
                        <tr>
                    ...
                    <table style={{
                        ...
                        {this.props.data[0].item.map((item, index) => {
                            return (
                    ...
                    <table style={{
                        ...
                        <tr >
                            ...
                            <td style={{
                                ...
                                borderRight: 'none',
                                paddingTop: 10
                            }}>Rs. {parseFloat(this.props.data[0].grossAmount).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style={{ paddingBottom: 10 }}>Discount Amount</td>
                            <td style={{ paddingBottom: 10 }}>:</td>
                            <td style={{ paddingBottom: 10 }}>Rs. {parseFloat(this.props.data[0].discount.value).toFixed(2)}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            {parseFloat(this.props.data[0].deliveryCharge).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style={{
                            ...
                            }}>Rs. {parseFloat(this.props.data[0].totalAmount + 25).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style={{ padding: 10, paddingRight: 0, paddingLeft: 0 }}>Paid Status</td>
                            <td style={{ padding: 10, paddingRight: 0, paddingLeft: 0 }} >:</td>
                            <td style={{ padding: 10, paddingRight: 0, paddingLeft: 0, textTransform: 'capitalize' }}>{this.props.data[0].paymentStatus}</td>
                        </tr>
                    </table>
                    <table style={{
